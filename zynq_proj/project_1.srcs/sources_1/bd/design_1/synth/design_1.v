...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN design_1_clk_0, FREQ_HZ 50000000, INSERT_VIP 0, PHASE 0.000" *) input clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.MIC_SCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.MIC_SCK, CLK_DOMAIN /clk_wiz_0_clk_out1, FREQ_HZ 6000000, INSERT_VIP 0, PHASE 0.0" *) output mic_sck;
  input [3:0]mic_sd;
  output mic_ws;
  ...
  wire mic2bram_0_done;
  wire [31:0]mic2bram_0_dout;
  wire mic2bram_0_mic_ck;
  wire mic2bram_0_mic_ws;
  wire [31:0]mic2bram_0_ram_addr;
  wire mic2bram_0_ram_en;
  wire mic2bram_0_ram_rst;
  wire [3:0]mic2bram_0_ram_we;
  wire [3:0]mic_sd_0_1;
  ...
  assign clk_0_1 = clk;
  assign mic_sck = mic2bram_0_mic_ck;
  assign mic_sd_0_1 = mic_sd[3:0];
  assign mic_ws = mic2bram_0_mic_ws;
  ...
  design_1_axi_lite_ctrl_0_0 axi_lite_ctrl_0
       (.id2pl(axi_lite_ctrl_0_id2pl),
        .id2ps(mic2bram_0_done),
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(mic2bram_0_ram_addr),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(clk_0_1),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(mic2bram_0_dout),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(mic2bram_0_ram_en),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(mic2bram_0_ram_rst),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(mic2bram_0_ram_we));
  design_1_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(clk_0_1),
        .clk_out1(clk_wiz_0_clk_out1),
        .reset(xlconstant_0_dout));
  design_1_mic2bram_0_0 mic2bram_0
       (.clk(clk_0_1),
        .din(blk_mem_gen_0_doutb),
        .done(mic2bram_0_done),
        .dout(mic2bram_0_dout),
        .mic_ck(mic2bram_0_mic_ck),
        .mic_sck(clk_wiz_0_clk_out1),
        .mic_sd(mic_sd_0_1),
        .mic_ws(mic2bram_0_mic_ws),
        .ram_addr(mic2bram_0_ram_addr),
        .ram_en(mic2bram_0_ram_en),
        .ram_rst(mic2bram_0_ram_rst),
        .ram_we(mic2bram_0_ram_we),
        .rst_n(processing_system7_0_FCLK_RESET0_N),
        .start(axi_lite_ctrl_0_id2pl));
